...
const DownloadCertificate = ({
  ...
  const handleUpload = async () => {
    ...
    if (!caseId) {
      setError('Tax return ID is missing.');
    ...
    try {
      ...
      const endpoint =
        role === 'ADMIN' || role === 'SUPER_ADMIN'
          ? `/admin/assignments/${caseId}/upload-final-certificate`
      ...
      if (response.data?.success) {
        toast.success('Final certificate uploaded successfully.');
        resetForm();
        ...
        <div className="p-6">
          ...
          <div className="flex justify-end space-x-3 mt-6">
            ...
            <button
              ...
              disabled={uploading || !selectedFile || !caseId}
            ...
            >
              ...
              <span>{uploading ? `Uploading... ${uploadProgress}%` : 'Upload & Notify Client'}</span>
            </button>
          </div>
        </div>
      </div>
