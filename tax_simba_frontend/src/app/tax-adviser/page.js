            ...
            <section className="stop-stressing-sec ptb-80 pt-0">
                <Container>
                    <div className="stop-stressing-content text-center">
                        ...
                        <Link href="/register" className="common-btn">
                            Start Self Assessment <MdKeyboardDoubleArrowRight className="ms-1" />
                        </Link>
                        <p className="no-card mt-4">Accountant-led support • Clear packages on pricing • Stay on top of your filing</p>
                    </div>
                </Container>
            </section>
