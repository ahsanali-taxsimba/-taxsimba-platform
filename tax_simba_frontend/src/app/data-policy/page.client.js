                    ...
                    <Row className="align-items-center">
                        <Col lg={6}>
                            <div className="bread-crum-inr-box text-lg-start text-center">
                                <TranslatedHeadingTwo className="text-capitalize mb-3">TaxSimba Data Policy</TranslatedHeadingTwo>
                                <TranslatedParagraph className="mb-0">Please read our data policy carefully to understand the professional guidelines and agreements for using TaxSimba’s UK tax compliance services.</TranslatedParagraph>
                            </div>
                        </Col>
                    ...
                    <div className="row">
                        <div className="col">
                            <div className="terms-content">
                                ...
                                <TranslatedParagraph>
                                    By accessing and using TaxSimba, you agree to comply with and be bound by this Data Policy. Our platform is designed to provide digital tax management and filing solutions for UK taxpayers. If you do not agree with any part of these terms, you must refrain from using our services.
                                </TranslatedParagraph>
                            </div>
                            <div className="terms-content">
                            ...
                            <div className="terms-content">
                                ...
                                <TranslatedParagraph>
                                    We may update this Data Policy from time to time to reflect changes in our services or legal requirements. We will notify you of any material changes by posting the updated terms on this page. Your continued use of the platform after such changes constitutes your acceptance of the new terms.
                                </TranslatedParagraph>
                            </div>
                        </div>
                    </div>
...
export default DataPolicyClient
